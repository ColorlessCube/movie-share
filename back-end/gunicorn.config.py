...
# ------------------------------------command------------------------------------
# 1> Modify the 'gunicorn.config.py' file (_ROOT/log/bind)
# 2> copy the 'gunicorn.config.py' file to the root directory of the application(where plex.py is located)
# 3> gunicorn -c gunicorn.config.py admin_app:app
